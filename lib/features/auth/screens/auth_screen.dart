...
import 'package:move_young/services/error_handler/error_handler_provider.dart';
...
class _AuthScreenState extends ConsumerState<AuthScreen> {
  ...
  Future<void> _handleAuth() async {
    ...
    try {
      ...
      // ErrorHandlerActions will handle logging safely
      final errorHandler = ref.read(errorHandlerActionsProvider);
