...
class ConnectivityAwareCachedIndicator extends ConsumerStatefulWidget {
  final Widget child;
  final VoidCallback? onRefresh;
  ...
  @override
  ConsumerState<ConnectivityAwareCachedIndicator> createState() =>
      _ConnectivityAwareCachedIndicatorState();
}

class _ConnectivityAwareCachedIndicatorState
    extends ConsumerState<ConnectivityAwareCachedIndicator> {
  @override
  Widget build(BuildContext context) {
    final isConnected = ref.watch(hasConnectionProvider);
    
    return CachedDataIndicator(
      isShowingCachedData: !isConnected,
