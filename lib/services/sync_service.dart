    ...
    try {
      switch (type) {
        case 'game_join':
          ...
          return await CloudGamesService.joinGame(gameId, playerId, playerName);

        case 'game_leave':
          final gameId = data['gameId'] as String;
          final playerId = data['playerId'] as String;
          return await CloudGamesService.leaveGame(gameId, playerId);

        case 'friend_request':
          final toUid = data['toUid'] as String;
          return await FriendsService.sendFriendRequestToUid(toUid);
